...
export default function LogIn() {
  ...
  return (
    <div className="grid h-[100dvh] overflow-hidden">
      ...
      <div className="self-center grid-area-1 mx-5 z-10">
        <h1 className="text-[48px] text-white mb-1">Log ind</h1>
        <form>
          {userInput}
          {passwordInput}
          <Link to="/activities" className="bg-primary mx-auto text-white p-4 text-center rounded-2xl text-base inline-block w-full outline-none">Log ind</Link>
        </form>
      </div>
    </div>
  );
